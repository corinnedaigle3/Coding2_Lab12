...
This lab creates a basic inventory list that searches/sorts the inventory in multiple ways.
...
• The Binary search takes an already sorted list and finds the item by Id.

• The Quicksort sorts the items by values from smallest to greatest. 
